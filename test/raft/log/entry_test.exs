defmodule RaftDB.Raft.Log.EntryTest do
  @moduledoc """
  Test for RaftDB.Raft.Log.Entry
  """

  use Croma.TestCase
  alias RaftDB.Raft.Persistence.{SnapshotMetadata, Store}
  ...
  defp make_entries_list do
    [
      ...
      {1, 2, :change_config, RaftDB.Raft.Node.make_config(__MODULE__)},
  ...
  test "read_last_entry_index/1 should return nil on failure" do
    ...
    assert RaftDB.Raft.Node.read_last_log_index(@dir) == nil
