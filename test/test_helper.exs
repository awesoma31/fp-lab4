...
defmodule MessageSendingHook do
  @moduledoc """
  Simple realization of `RaftDB.Raft.Communication.LeaderHook`
  """

  @behaviour RaftDB.Raft.Communication.LeaderHook
...
defmodule CommunicationWithNetsplit do
  @moduledoc """
  Simple realization of `RaftDB.Raft.Communication.Communicable`
  """
...
defmodule RaftDB.ConsensusGroups.Config.PerMemberOptionsMaker.Persist do
  @moduledoc """
  ...
  alias RaftDB.ConsensusGroups.Config.PerMemberOptionsMaker
...
defmodule RaftDB.ConsensusGroups.Config.PerMemberOptionsMaker.Raise do
  @moduledoc """
...
defmodule RaftDB.ConsensusGroups.Config.PerMemberOptionsMaker.Timeout do
  @moduledoc """
...
defmodule SlaveNode do
  ...
  alias RaftDB.ConsensusGroups.Cluster.{Cluster, Manager}
  ...
  def start_slave(shortname, persist \\ :random) do
    ...
    {:ok, _} = Application.ensure_all_started(:raft_db) |> at(longname)
...
defmodule PersistenceSetting do
  ...
  alias RaftDB.ConsensusGroups.Config.PerMemberOptionsMaker.Persist
  ...
  def turn_on_persistence(longname) do
    Application.put_env(:raft_db, :per_member_options, Persist) |> at(longname)
  end
end
