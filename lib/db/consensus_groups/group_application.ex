...
defmodule RaftDB.ConsensusGroups.GroupApplication do
  @moduledoc """
  Public interface functions of consensus groups managing.
  """

  use Application
  alias RaftDB.ConsensusGroups.Cache.LeaderPidCache
  alias RaftDB.ConsensusGroups.Config.Config
  alias RaftDB.ConsensusGroups.Cluster.{Cluster, Manager}
  alias RaftDB.ConsensusGroups.GroupApplication, as: App

  alias RaftDB.ConsensusGroups.OTP.{
  ...
  alias RaftDB.ConsensusGroups.Types.ZoneId
