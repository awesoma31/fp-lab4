...
defmodule RaftDB.ConsensusGroups.OTP.ConsensusMemberSupervisor do
  @moduledoc """
  A supervisor for managing consensus members in the RaftDB system.
  ...
  alias RaftDB.ConsensusGroups.Config.PerMemberOptions
