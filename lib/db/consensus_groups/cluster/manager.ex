...
defmodule RaftDB.ConsensusGroups.Cluster.Manager do
  @moduledoc false
  use GenServer
  require Logger

  alias RaftDB.ConsensusGroups.GroupApplication
  alias RaftDB.ConsensusGroups.Cluster.{Activator, ConsensusMemberAdjuster, Deactivator}
  alias RaftDB.ConsensusGroups.Config.Config
  alias RaftDB.ConsensusGroups.OTP.{ConsensusMemberSupervisor, ProcessAndDiskLogIndexInspector}
