...
defmodule RaftDB.ConsensusGroups.Cluster.Cluster do
  @moduledoc """
  ...
  alias RaftDB.ConsensusGroups.Cluster.{Manager, RecentlyRemovedGroups}
  alias RaftDB.ConsensusGroups.Config.{Config, PerMemberOptions}
  alias RaftDB.ConsensusGroups.Types.{ConsensusGroups, MembersPerLeaderNode}
  alias RaftDB.ConsensusGroups.Utils.NodesPerZone
  alias RaftDB.Raft.Node, as: RaftNode
  alias RaftDB.Raft.StateMachine.Statable
  alias RaftDB.Raft.Types.Config, as: RaftConfig
  ...
  defmodule Server do
    ...
    defun start_link(raft_config :: RaftConfig.t(), name :: g[atom]) :: GenServer.on_start() do
      ...
      :global.trans(
        {:raft_db_cluster_state_initialization, self()},
        fn ->
  ...
  defmodule Hook do
    ...
    alias RaftDB.ConsensusGroups.Cluster.Manager
    alias RaftDB.ConsensusGroups.Config.Config
    alias RaftDB.Raft.Communication.LeaderHook
    ...
    defp start_consensus_group_if_not_restoring(group_name, raft_config, nodes) do
      restoring? = Process.get(:raft_db_raft_rpc_server_restoring, false)
