...
defmodule RaftDB.Raft.Communication.Members do
  @moduledoc """
  The `RaftDB.Raft.Communication.Members` module manages the membership of nodes in a Raft consensus algorithm implementation.
  ...
  alias RaftDB.Raft.Types.LogIndex
  ...
  ## Examples
      ...
      iex> RaftDB.Raft.Communication.Members.new_for_lonely_leader()
      %RaftDB.Raft.Communication.Members{leader: #PID<0.123.0>, all: #PidSet<...>, uncommitted_membership_change: nil, pending_leader_change: nil}
  """
  ...
  ## Examples
      ...
      iex> members = %RaftDB.Raft.Communication.Members{all: PidSet.put(PidSet.new(), self())}
      iex> RaftDB.Raft.Communication.Members.other_members_list(members)
      []
  """
  ...
  ## Examples
      ...
      iex> members = %RaftDB.Raft.Communication.Members{leader: nil}
      iex> RaftDB.Raft.Communication.Members.put_leader(members, self())
      %RaftDB.Raft.Communication.Members{leader: #PID<0.123.0>, ...}
  """
  ...
  ## Examples
      ...
      iex> members = %RaftDB.Raft.Communication.Members{all: PidSet.new()}
      iex> RaftDB.Raft.Communication.Members.start_adding_follower(members, {1, 1, :add_follower, new_follower_pid})
      %RaftDB.Raft.Communication.Members{...}
  """
  ...
  ## Examples
      ...
      iex> members = %RaftDB.Raft.Communication.Members{all: PidSet.put(PidSet.new(), old_follower_pid)}
      iex> RaftDB.Raft.Communication.Members.start_removing_follower(members, {1, 1, :remove_follower, old_follower_pid})
      %RaftDB.Raft.Communication.Members{...}
  """
  ...
  ## Examples
      ...
      iex> members = %RaftDB.Raft.Communication.Members{all: PidSet.new()}
      iex> RaftDB.Raft.Communication.Members.start_replacing_leader(members, new_leader_pid)
      %RaftDB.Raft.Communication.Members{...}
  """
  ...
  ## Examples
      ...
      iex> members = %RaftDB.Raft.Communication.Members{uncommitted_membership_change: {1, 1, :add_follower, follower_pid}}
      iex> RaftDB.Raft.Communication.Members.membership_change_committed(members, 1)
      %RaftDB.Raft.Communication.Members{...}
  """
  ...
  ## Examples
      ...
      iex> members = %RaftDB.Raft.Communication.Members{all: PidSet.put(PidSet.new(), pid_to_remove)}
      iex> RaftDB.Raft.Communication.Members.force_remove_member(members, pid_to_remove)
      %RaftDB.Raft.Communication.Members{...}
  """
