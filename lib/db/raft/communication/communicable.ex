...
defmodule RaftDB.Raft.Communication.Communicable do
  @moduledoc """
  Defines the communication interface for RaftDB.Raft.
...
defmodule RaftDB.Raft.Communication.RemoteMessageGateway do
  @moduledoc """
  Default implementation of `:communication_module` for RaftDB.Raft.
