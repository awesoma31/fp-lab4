...
defmodule RaftDB.Raft.Log.Entry do
  @moduledoc """
  The `RaftDB.Raft.Log.Entry` module defines the structure and functionality for log entries in the Raft consensus algorithm.
  ...
  alias RaftDB.Raft.Types.{Config, LogIndex, TermNumber}
  alias RaftDB.Raft.Types.Error.RedundantSizeInformationError
  ...
  ## Examples
      ...
      iex> RaftDB.Raft.Log.Entry.to_binary(entry)
  ...
  ## Examples
      ...
      iex> entries = RaftDB.Raft.Log.Entry.read_as_stream("log_file_path")
  ...
  ## Examples
      ...
      iex> last_index = RaftDB.Raft.Log.Entry.read_last_entry_index("log_file_path")
      5
  """
