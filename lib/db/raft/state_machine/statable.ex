defmodule RaftDB.Raft.StateMachine.Statable do
  @moduledoc """
  A behaviour that defines data to be replicated by RaftDB's Raft nodes.
  ...
  Whenever a new consensus group is started by `RaftDB.Raft.Node.start_link/2`
  ...
  This callback function is invoked by `RaftDB.Raft.Node.command/4`.
  ...
  This callback function is invoked by `RaftDB.Raft.Node.query/3`.
